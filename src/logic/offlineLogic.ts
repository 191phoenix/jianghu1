...
import { rollDrop, rollStones, rollSilver } from './equipmentLogic'

const MAX_OFFLINE_SEC = 8 * 3600
const SEC_PER_SWEEP = 30

/** 离线挂机结算：按离线时长扫荡最高已通关卡，结算经验/掉落/强化石/银两 */
export function settleOffline(
  ...
  return { duration, exp, drops, stones, silver, levelId: maxLevel.id }
}
